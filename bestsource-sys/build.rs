...
fn main() {
    ...
    if !bestsource_library_dir.join("libbestsourcew.a").exists() {
        panic!("Missing compiled libbestsourcew.a! Please build BestSource according to the instructions in the README.");
    }
    ...
    println!("cargo:rustc-link-lib=static:+whole-archive,+bundle=bestsourcew");
