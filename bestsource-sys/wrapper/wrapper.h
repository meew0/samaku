...
#include <stdint.h>
    ...
    struct BSW_PointerWithError BestAudioSource_new(const char *SourceFile, int Track, int AjustDelay, int VariableFormat, int Threads, int CacheMode, const char *CachePath, double DrcScale, int (*Progress)(int, int64_t, int64_t));
